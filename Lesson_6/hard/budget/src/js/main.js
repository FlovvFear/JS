...
optExpensesBtn.style.opacity = 0.5;
...
expensesInputs.forEach(function(item, i, array) {
  ...
  item.addEventListener('input', function(e) {
		array[1].value = array[1].value.replace(/[^0-9+]/, '');
		array[3].value = array[3].value.replace(/[^0-9+]/, '');
...
optExpensesInputs.forEach(function(item) {
  ...
  item.addEventListener('input', function() {
    ...
    if ((item.value != "")) {
      ...
      optExpensesBtn.style.opacity = 1;
